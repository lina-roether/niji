...
impl Default for TerminalThemeSpec<Dark> {
	fn default() -> Self {
		Self {
			...
			dark_red: Some(ColorRef::named("red").into()),
			dark_green: Some(ColorRef::named("green").into()),
			dark_yellow: Some(ColorRef::named("yellow").into()),
			dark_blue: Some(ColorRef::named("blue").into()),
			dark_magenta: Some(ColorRef::named("purple").into()),
			dark_cyan: Some(ColorRef::named("teal").into()),
...
impl Default for TerminalThemeSpec<Light> {
	fn default() -> Self {
		Self {
			...
			dark_black: Some(ColorRef::named("white").into()),
			dark_red: Some(ColorRef::named("red").into()),
			dark_green: Some(ColorRef::named("green").into()),
			dark_yellow: Some(ColorRef::named("yellow").into()),
			dark_blue: Some(ColorRef::named("blue").into()),
			dark_magenta: Some(ColorRef::named("purple").into()),
			dark_cyan: Some(ColorRef::named("teal").into()),
			bright_white: Some(ColorRef::named("black").into()),
