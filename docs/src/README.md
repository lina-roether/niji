...
Refer to [Getting Started](./getting-started.md) for a quick guide on how to set
niji up, or take a look at [Configuration](./configuration.md) and
[Built-in Modules](./modules/) for a more in-depth reference of niji's
capabilities.
